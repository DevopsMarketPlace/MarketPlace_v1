...
function updateCartTotal() {
    ...
    $.get( "http://localhost:8085/store/product/"+qsParm["sid"])
        .done(function(data,status,xhr)
        {
            ...
            data.map((x,index)=>{$("#forloop").append('<div class="shop-item"><input class="pid" type="hidden"  value="'+x.pid+'"/><span class="shop-item-title">'+x.pname+'</span><img class="shop-item-image" src="assets/img/product3.png"><div class="shop-item-details"><h4>Product Price:<span class="shop-item-price">Rs '+x.pprice+'</span><h4></div><div class="shop-item-details"><h5>Discounted Price:Rs <span class="shop-item-discount-price">'+x.disprice+'</span></h5></div><div class="shop-item-details"><input class="btn btn-primary" type="button" value="ADD TO CART" ></input></div></div>')});
